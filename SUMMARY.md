...
* [記憶體管理(memory management)](os-essential/memory-management/README.md)
  * [分頁(paging)](os-essential/memory-management/paging.md)
  * [虛擬記憶體(virtual memory)](os-essential/memory-management/virtual-memory.md)
  * [記憶體置換(memory swapping)](os-essential/memory-management/memory-swapping.md)
...
* [CPU快取一致性協議MESI](os-essential/cpu-mesi.md)
* [中斷(interrupt)](os-essential/interrupt.md)
* [系統呼叫(system call)](os-essential/system-call.md)
